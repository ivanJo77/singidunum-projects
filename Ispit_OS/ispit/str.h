...
{  
  ...
  */
  ...
  /*
    Checks if a string is a valid null-terminated string.

    IN pstrString - string to check.
    IN dwSize     - size in characters.
  ...
  */
  ...
  /*
    Checks whether a string is a decimal number.

	IN pstrString - string to check.
	IN iSize      - size in characters, or -1.

    Return        - true - string is a decimal number,
                    false - string is not a decimal number.
  */
  bool _IsDecimalStringW(LPCWSTR pstrString, int iSize);

  /*
    Converts the byte in the 16-bit decimal number.
  ...
  */
  ...
  /*
    Adding a Unicode string to the end of another string.

    IN buf    - buffer.
	IN source - source string, may be NULL.
	IN size   - number of characters to copy, or -1 to copy complete string.
  */
  void _catW(LPWSTR buf, LPWSTR source, int size);

  /*
    Adding a Unicode string to the end of another string, with memory allocation.

    IN OUT ppstrBuf - buffer.
	IN pstrSource   - source string, may be NULL.
	IN iSize		- number of characters to copy, or -1 to copy complete string.
  */
  ...
  */
  ...
  /*
    Adding ANSI string to the other end of the other string.
  ...
  */
  ...
  /*
    Adding an ANSI string to the end of another string, with memory allocation.
  ...
  */
  ...
  /*
    Delete characters \r, \n, \t and spaces from the beginning and the end of the ANSI string.

    IN pstrStr - string to process.
  */
  void _TrimA(LPSTR pstrStr);

  /*
    Delete characters \r, \n, \t and spaces from the beginning and the end of the Unicode string.
  ...
  */
  ...
  /*
    Convert decimal/hexadecimal ANSI string into int64. Converting until encounter different 
	character then '0'-'F'.

    IN pstrStr - string to process.
    OUT pbSign - if not NULL, it returns: true - if the number has the sign '-', 
				 false - if the number hasn't sign '-'.
  ...
  */
  ...
  /*
    Convert decimal/hexadecimal ANSI string into int32. Converting until encounter different 
	character then '0'-'F'.
  ...
  */
  ...
  /*
	Convert decimal/hexadecimal Unicode string into int64. Converting until encounter different 
	character then '0'-'F'.
  ...
  */
  ...
  /*
	Convert decimal/hexadecimal Unicode string into int32. Converting until encounter different 
	character then '0'-'F'.
  ...
  */
  ...
  /*
    Convert int64 number into an ANSI string.

    IN iNumber - source number.
    OUT pBuf   - buffer.
    IN bRadix  - scale.
    IN bSigned - true - if the number is signed, false - if the number is unsigned.

    Return     - the number of bytes copied in pBuf.
  */
  DWORD _FromInt64A(__int64 iNumber, LPSTR pBuf, BYTE bRadix, bool bSigned);
  
  /*
	Convert int32 number into an ANSI string.
  ...
  */
  ...
  /*
	Convert int64 number into a Unicode string.
  ...
  */
  ...
  /*
	Convert int32 number into a Unicode string.
  ...
  */
  ...
  /*
	Convert ANSI string to a DWORD. Converting until encounter different 
	character then '0' - '9', 'A' - 'F', 'a' - 'f'. Also, if at the beginning 
	of the line is the 0x prefix, it's skipped.
  ...
  */
  ...
  /*
	Convert Unicode string to a DWORD. Converting until encounter different 
	character then '0' - '9', 'A' - 'F', 'a' - 'f'. Also, if at the beginning 
	of the line is the 0x prefix, it's skipped.
  ...
  */
  ...
  /*
    Converting HEX-string in the binary data.

    IN string  - string.
    OUT buffer - buffer. May be a pointer to a string.

    Return     - true - if the string is successfully converted, or empty, 
